...
class Instollowing:
    ...
    def getFollowersAndFollowing(self):
        ...
        for follower in followers_list:
            followers.append(follower.username + ";" + self.instagramLink + follower.username + ";none")

        for followee in following_list:
            following.append(followee.username + ';' + self.instagramLink + followee.username)
    ...
    def run(self):
        if self.username is None or self.password is None:
            following, followers = self.parseJson('following.json'), self.parseJson('followers.json')
        else:
